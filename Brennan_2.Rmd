...
|  ![Tables 2.2 and 2.3 from Brennan R.L., Generalizability Theory](https://github.com/Papa-26/Brennan/blob/main/Table_2_2.png)
...
![Side by side results from R and from "Generalizability Theory](https://github.com/Papa-26/Brennan/blob/main/ResultsBrennan.png)
<br>
...
![R Analysis of website MCQ data](https://github.com/Papa-26/Brennan/blob/main/DataMCQgh.png)

<br>

When we compare this with the results from G-String:

|    ![ANOVA](https://github.com/Papa-26/Brennan/blob/main/ANOVA.png)

<br> we see that sum scores and variance components are spot on! but let's now look at the Generalizability Coefficients:

|    ![Generalizability Coefficients](https://github.com/Papa-26/Brennan/blob/main/GC.png)
