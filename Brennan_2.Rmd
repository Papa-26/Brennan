...
|  ![Tables 2.2 and 2.3 from Brennan R.L., Generalizability Theory](Table_2_2.png)
...
![Side by side results from R and from "Generalizability Theory](ResultsBrennan.png)
<br>
