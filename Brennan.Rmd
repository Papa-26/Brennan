...
**Important !**\
If you want to actually download, and play around with the R script, you need to also download the files 'Data_Brennan_2.2.png', 'DataMCQgh.png', 'DataMCQ Scores.png', 'ResultsBrennan.png', scores.csv, ScoresMCQgh.csv and 'Table_2_2.png' from <https://github.com/Papa-26/Brennan>, and load them into the corresponding R working directory.
